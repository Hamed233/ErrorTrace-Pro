"""
Flask web application for ErrorTrace Pro demonstration
"""
import os
import sys
import json
...
# Add the current directory to sys.path to import the package in development
sys.path.insert(0, os.path.abspath('.'))

import errortrace_pro

app = Flask(__name__)
app.config['SECRET_KEY'] = os.environ.get("SESSION_SECRET", "errortrace-dev-key")
